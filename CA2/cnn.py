...
model = Sequential()
# conv1
model.add(Conv2D(filters=20, kernel_size=5, strides=1, padding="same", input_shape=(28, 28, 1)))
...
# model = Sequential()
# # conv1
# model.add(Conv2D(filters=20, kernel_size=3, strides=1, padding="same", input_shape=(28, 28, 1)))
# model.add(MaxPool2D(pool_size=2, strides=2))
#
# # con2
